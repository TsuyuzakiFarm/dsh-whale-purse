/**
 * whale-purse — 配置契约（Config schema）。
 *
...
const FIELDS = {
  ...
  statePath: { type: 'string', default: join(DSH_HOME, 'whale-purse.settings.json'), maxLength: 1024 },
  holidayCachePath: { type: 'string', default: join(DSH_HOME, 'whale-purse.holidays.json'), maxLength: 1024 },
}
